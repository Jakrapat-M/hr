# Cnext Design System — Token Reference

> Central Group HR (Cnext) design tokens — Tailwind v4 `@theme` SSOT ที่
> `src/frontend/src/app/globals.css`. Reference สำหรับ component builders
> + screen builders ใน Sprint Adapt from Shelfly Bundle.
>
> Ref: `specs/cnext-frontend-redesign.md` · `docs/shelfly-hr-design-research.md`
