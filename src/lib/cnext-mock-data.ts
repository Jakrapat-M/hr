...
// claim-field-config → benefit-claims → cnext-mock-data is also type-only, so
...
export interface CnextEmployee {
  id: string;
  employeeCode: string;
  firstNameTh: string;
  lastNameTh: string;
...
export const CNEXT_EMPLOYEES: CnextEmployee[] = [
  {
    id: 'emp-001',
...
export interface CnextApprovalRequest {
  id: string;
  employeeId: string;
...
export const CNEXT_PENDING_REQUESTS: CnextApprovalRequest[] = [
  {
    id: 'req-1',
    employeeId: 'emp-004',
    type: 'leave-vacation',
...
export interface CnextActivityItem {
  id: string;
  title: string;
  timeLabel: string;
...
export const CNEXT_RECENT_ACTIVITY: CnextActivityItem[] = [
  {
    id: 'act-1',
...
export const CNEXT_KPIS: CnextKpi[] = [
  {
    id: 'kpi-headcount',
...
export const CNEXT_LATEST_PAYROLL = {
...
export const AVATAR_TONE_CLASS: Record<CnextEmployee['avatarTone'], string> = {
...
export interface CnextLearningCourse {
  id: string;
  title: string;
...
export const CNEXT_LEARNING_PATH = {
...
export const CNEXT_LEARNING_CERTIFICATIONS: Array<{
  name: string;
  expiryLabel: string;
...
export const CNEXT_LEARNING_TEAM_READINESS = {
...
export const CNEXT_LEARNING_COURSES: CnextLearningCourse[] = [
  {
    id: 'course-1',
...
export type CnextOrgTone = 'teal' | 'sage' | 'butter' | 'ink' | 'coral';

export interface CnextOrgPerson {
  id: string;
  name: string;
  role: string;
  department: string;
...
export const CNEXT_ORG_PEOPLE: Record<string, CnextOrgPerson> = {
  grace: {
    id: 'grace',
    name: 'วาสนา จิรวัฒน์',
...
export interface CnextIntegration {
  id: string;
  name: string;
  ...
  /** Cnext token name (not raw hex) */
  markToneClass: string;
}

export const CNEXT_INTEGRATION_CATEGORIES: Array<{
...
export const CNEXT_INTEGRATIONS: CnextIntegration[] = [
  {
    id: 'int-workday',
    name: 'Workday HRIS',
    category: 'hris',
...
export const CNEXT_INTEGRATION_KPIS = [
...
export const CNEXT_TODAY_PRESENCE = {
  workingCount: 1147,
  totalCount: 1284,
  present: 1147,
  absent: 46,
...
export const CNEXT_PENDING_DOCS: CnextDocItem[] = [
  {
    id: 'doc-benefits',
...
export const CNEXT_WEEK_RECOGNITION = {
  eyebrow: 'สัปดาห์นี้',
...
export interface CnextCalEvent {
  id: string;
  title: string;
  timeLabel: string;
  tone: 'accent' | 'warning';
...
export const CNEXT_CAL_EVENTS: CnextCalEvent[] = [
  {
    id: 'cal-1',
...
export type CnextAnnouncementKind = 'ops' | 'policy' | 'recog';

export interface CnextAnnouncement {
  id: string;
  author: string;
  ...
  reactions: string[];
  comments: number;
  kind: CnextAnnouncementKind;
  pinned?: boolean;
}

export const CNEXT_ANNOUNCEMENTS: CnextAnnouncement[] = [
  {
    id: 'ann-1',
...
export const CNEXT_CHANNELS: CnextChannel[] = [
...
const CNEXT_LIFECYCLE_EVENTS: LifecycleEvent[] = [
...
const _yos  = calcYearOfService('2019-03-01', CNEXT_LIFECYCLE_EVENTS)
const _yij  = calcYearsInJob(CNEXT_LIFECYCLE_EVENTS)
const _yip  = calcYearsInPosition(CNEXT_LIFECYCLE_EVENTS)
const _yibu = calcYearsInBU(CNEXT_LIFECYCLE_EVENTS)
const _yict = calcYearsInCorpTitle(CNEXT_LIFECYCLE_EVENTS)

export const CNEXT_MY_PROFILE = {
  ...
  hireDate: '2019-03-01',
  lifecycleEvents: CNEXT_LIFECYCLE_EVENTS,
  ...
  // confirmed 3 fields: Name / Relationship / Phone (+ Cnext adds initials/tone for UI).
  emergency: [
...
/** Subset of CnextEmployee.avatarTone that the Avatar primitive accepts directly. */
...
export interface CnextLeaveBalance {
  kind: LeaveKind;
  label: string;
  remaining: string;
  unitLabel: string;
 ...
 */
export const CNEXT_TH_HOLIDAYS: string[] = [
...
export const CNEXT_LEAVE_BALANCES: CnextLeaveBalance[] = [
  {
    kind: 'vacation',
    label: 'ลาพักร้อน',
    remaining: '8.5',
...
export interface CnextLeaveHistoryItem {
  id: string;
  when: string;
  type: string;
...
export const CNEXT_LEAVE_HISTORY: CnextLeaveHistoryItem[] = [
...
export interface CnextLeavePending {
  id: string;
  name: string;
  initials: string;
  tone: AvatarTone;
...
export const CNEXT_LEAVE_PENDING: CnextLeavePending[] = [
...
export interface CnextLeaveCoverage {
  id: string;
  name: string;
  initials: string;
  tone: AvatarTone;
...
export const CNEXT_LEAVE_COVERAGE: CnextLeaveCoverage[] = [
...
export interface CnextBenefitPlan {
  id: string;
  title: string;
  plan: string;
  cost: string;
...
export const CNEXT_BENEFIT_PLANS: CnextBenefitPlan[] = [
  {
    id: 'bp-health',
...
export interface CnextDependent {
  id: string;
  fullNameTh: string;
  fullNameEn: string;
...
export const CNEXT_DEPENDENTS: CnextDependent[] = [
  {
    id: 'dep-1',
...
export interface CnextClaimAllowance {
  id: string;
  label: string;
  used: number;
  limit: number;
...
export const CNEXT_CLAIM_ALLOWANCES: CnextClaimAllowance[] = [
  {
...
export interface CnextClaimHistoryItem {
  id: string;
...
export const CNEXT_CLAIM_HISTORY: CnextClaimHistoryItem[] = [
  {
...
export const CNEXT_PAYSLIPS: CnextPayslip[] = [
...
export interface CnextRequestFormType {
  id: string;
  title: string;
  subtitle: string;
  icon: RequestIconKey;
...
export const CNEXT_REQUEST_CATALOG: CnextRequestFormType[] = [
...
export interface CnextApprovalStep {
  role: string;
  name: string;
  initials: string;
  tone: AvatarTone;
...
export interface CnextMyRequest {
  id: string;
  type: string;
  sub: string;
  submitted: string;
...
export const CNEXT_MY_REQUESTS: CnextMyRequest[] = [
  {
...
export interface CnextApprovalRow {
  id: string;
  who: string;
  initials: string;
  tone: AvatarTone;
...
export const CNEXT_APPROVAL_QUEUE: CnextApprovalRow[] = [
...
export interface CnextGoalKR {
  label: string;
  done: boolean;
}

export interface CnextGoal {
  id: string;
  title: string;
  category: string;
  percent: number;
...
export const CNEXT_GOALS: CnextGoal[] = [
  {
    id: 'goal-1',
...
export interface CnextReviewCycle {
  id: string;
  cycle: string;
  due: string;
  status: string;
...
export const CNEXT_REVIEW_CYCLES: CnextReviewCycle[] = [
...
export interface CnextFeedback {
  id: string;
  who: string;
  initials: string;
  tone: AvatarTone;
...
export const CNEXT_FEEDBACK: CnextFeedback[] = [
  {
    id: 'fb-1',
    who: 'กฤตนัย อินทรเดช',
    initials: 'กอ',
...
export interface CnextGoalTeamMember {
  id: string;
  name: string;
  initials: string;
  tone: AvatarTone;
...
export const CNEXT_GOAL_TEAM: CnextGoalTeamMember[] = [
...
export const CNEXT_HR_DOCS: CnextHrDoc[] = [
