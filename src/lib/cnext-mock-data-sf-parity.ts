...
//   - Existing CNEXT_EMPLOYEES (12) preserved verbatim — overlay applied at read time
//
...
export type CnextEmployeeOverlay = Partial<Omit<CnextEmployee, 'id' | 'employeeCode' | 'firstNameTh' | 'lastNameTh' | 'initials'>>;

export const SF_PARITY_NEW_EMPLOYEES: CnextEmployee[] = [
  {
    "id": "emp-013",
...
export const SF_PARITY_OVERLAY: Record<string, CnextEmployeeOverlay> = {
  "emp-001": {
    "firstNameEn": "Wassana",
    "lastNameEn": "Jirawat",
    "nickname": "Nan",
...
export function withSfParity<T extends CnextEmployee>(emp: T): T {
