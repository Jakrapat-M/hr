...
// C10: bilingual (labelTh + labelEn). C7: reuse cnext-card/cnext-eyebrow — no new CSS.
...
export function QuickActionsTile({
  ...
  return (
    <div className="cnext-card" role="region" aria-label={eyebrow}>
        ...
        {actions.map((action) => {
          ...
          return (
            <Link
              ...
              className="cnext-quick-action-item"
            >
              <span
