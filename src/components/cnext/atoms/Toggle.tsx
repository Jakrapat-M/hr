...
// ════════════════════════════════════════════════════════════
// Cnext Toggle — iOS-style switch with Thai-first label block.
...
// - focus-visible ring บน teal ตาม Cnext primitives.
// ════════════════════════════════════════════════════════════
...
export const Toggle = forwardRef<HTMLButtonElement, ToggleProps>(
  (
    ...
    const autoId = useId();
    const id = idProp ?? `cnext-toggle-${autoId}`;
...
Toggle.displayName = 'CnextToggle';
