...
// ════════════════════════════════════════════════════════════
// Cnext FormField — label + input wrapper.
...
export const FormField = forwardRef<HTMLDivElement, FormFieldProps>(
  ({ id: idProp, label, help, error, required, description, children, className }, ref) => {
    const autoId = useId();
    const id = idProp ?? `cnext-field-${autoId}`;
...
FormField.displayName = 'CnextFormField';

// ────────────────────────────────────────────────────────────
// Convenience input — styled <input> that matches Cnext tokens.
...
FormInput.displayName = 'CnextFormInput';
