/**
 * Nav.test.tsx — Cnext Nav (vertical sidebar) primitive tests
...
// ────────────────────────────────────────────────────────────
// Test fixture — 3 sections ตาม Cnext spec
// ────────────────────────────────────────────────────────────
...
describe('Nav — brand + footer slots', () => {
  it('render brand slot เมื่อส่ง brand prop', () => {
    render(
      <Nav
        sections={SECTIONS}
        ariaLabel="เมนูหลัก"
        brand={<span>Cnext Logo</span>}
      />
    );
    expect(screen.getByText('Cnext Logo')).toBeInTheDocument();
  });
  ...
  it('displayName = "CnextNav"', () => {
    expect(Nav.displayName).toBe('CnextNav');
  });
});
