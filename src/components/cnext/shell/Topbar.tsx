...
export function Topbar({
  ...
  return (
    <div ref={topbarRef} className="cnext-topbar" data-scrolled={scrolled}>
      ...
      <button
        type="button"
        className="cnext-menu-btn lg:!hidden"
        aria-label={mobileMenuOpen ? 'ปิดเมนู' : 'เปิดเมนู'}
        aria-expanded={mobileMenuOpen}
        aria-controls="cnext-mobile-drawer"
      ...
      <div className="cnext-spacer" />

      {/* Search pill — hidden on mobile, visible sm+ */}
      <div
        className="cnext-search !hidden sm:!flex"
        role="search"
        aria-label="ค้นหา"
      ...
      >
        ...
        <span className="cnext-search-placeholder">
          ค้นหาพนักงาน เอกสาร…
        </span>
      ...
      <button
        type="button"
        className="cnext-icon-btn sm:!hidden"
        aria-label="ค้นหา"
        onClick={onSearchClick}
      >
