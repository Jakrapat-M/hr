...
// ════════════════════════════════════════════════════════════
// Cnext AppShell — replaces the invented 6-item AppShell with
 ...
 *  title entry here, otherwise topbar falls back to 'Cnext' and visually
 *  duplicates the sidebar brand logo (Ken UAT 2026-04-22 "double cnext"). */
const TITLE_MAP: Array<{ prefix: string; title: string }> = [
  ...
  { prefix: '/th/workflows/probation', title: 'ทดลองงาน' },
  { prefix: '/en/workflows/probation', title: 'ทดลองงาน' },
  { prefix: '/th/workflows/resignation', title: 'อนุมัติการลาออก' },
  { prefix: '/en/workflows/resignation', title: 'อนุมัติการลาออก' },
  ...
  { prefix: '/th/team/shift-assign', title: 'จัดกะให้พนักงาน' },
  { prefix: '/en/team/shift-assign', title: 'Shift Assignment' },
  ...
  { prefix: '/th/hrbp/doc-review', title: 'คิวตรวจเอกสาร' },
  { prefix: '/en/hrbp/doc-review', title: 'Document Review' },
  { prefix: '/th/hrbp/talent-search', title: 'ค้นหาคนเก่ง' },
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className={`cnext-app${sidebarOpen ? '' : ' sidebar-collapsed'}`}>
      ...
      {/* Desktop sidebar — hidden below lg via .cnext-sidebar CSS; hidden on
      ...
      {/* Mobile drawer overlay — renders only when open. Wrapper has no width
          (drop the previous `w-[256px]` which mismatched .cnext-sidebar--drawer's
