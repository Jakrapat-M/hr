...
<body>
 ...
 ${referral.amount ? `
 <div class="section">
 <p class="section-title">${t('amount')}</p>
 <div class="grid">
 <div><p class="field-label">Authorized Amount</p><p class="field-value">${referral.amount.toLocaleString()} THB</p></div>
 </div>
 </div>
 <hr />` :''}
 <div class="section">
 ...
 <div>
 <span className="text-ink-muted">{t('referralNumber')}:</span>{''}
 <span className="font-medium">{referral.referralNumber || referral.id}</span>
 </div>
 <div>
 <span className="text-ink-muted">Date Issued:</span>{''}
 ...
 {/* Main content box */}
 <div className="border border-hairline border-hairline rounded-md p-6 space-y-4 bg-surface-raised text-sm">
 {/* Employee info */}
 <div>
 ...
 <div>
 <p className="text-ink-muted text-xs">Employee Name</p>
 <p className="font-semibold text-ink">{referral.employeeName}</p>
 </div>
 <div>
 <p className="text-ink-muted text-xs">Employee ID</p>
 <p className="font-semibold text-ink">{referral.employeeId}</p>
 </div>
 </div>
 </div>

 <hr className="border-hairline border-hairline" />
 ...
 <div className="grid grid-cols-2 gap-3">
 <div>
 <p className="text-ink-muted text-xs">Hospital</p>
 <p className="font-semibold text-ink">{referral.hospitalName}</p>
 </div>
 {referral.hospitalBranch && (
 <div>
 <p className="text-ink-muted text-xs">Branch</p>
 <p className="font-semibold text-ink">{referral.hospitalBranch}</p>
 </div>
 )}
 </div>
 </div>
 ...
 {referral.validFrom && (
 <div>
 <p className="text-ink-muted text-xs">{t('validFrom')}</p>
 <p className="font-semibold text-ink">{referral.validFrom}</p>
 </div>
 )}
 {referral.validUntil && (
 <div>
 <p className="text-ink-muted text-xs">{t('validUntil')}</p>
 <p className="font-semibold text-ink">{referral.validUntil}</p>
 </div>
 )}
 </div>
 </div>
 ...
 <div className="grid grid-cols-2 gap-3">
 <div>
 <p className="text-ink-muted text-xs">Authorized Amount</p>
 <p className="font-semibold text-ink">
 {referral.amount.toLocaleString()} THB
 </p>
 </div>
 </div>
 </div>
 ...
 <p className="text-ink-soft leading-relaxed">{referral.reason}</p>
 </div>
 </div>
 ...
 {/* Footer note */}
 <div className="mt-6 pt-4 border-t border-hairline border-hairline text-center">
