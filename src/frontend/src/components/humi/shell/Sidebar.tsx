...
export const MODULES: ModuleGroup[] = [
  ...
  },
  {
    ...
    leaves: [
      ...
      { id: 'team-overview', label: 'Team Overview', labelTh: 'ภาพรวมทีม', href: '/team-overview', show: ['manager', 'hradmin', 'hris'] }, // STA-245 — manager attendance dashboard (on-time/late/absent/OT); same guard as roster, remove-not-hide for others
