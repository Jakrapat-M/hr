...
export const MODULES: ModuleGroup[] = [
  ...
  },
  {
    ...
    leaves: [
      ...
      { id: 'team-payroll', label: 'Team Pay Summary', labelTh: 'สรุปค่าตอบแทนทีม', href: '/manager/payroll-summary', show: ['hradmin', 'sysadmin'] }, // read-only team comp rollup — Manager removed: line managers must not see per-person team comp (privacy/data-minimization); HR comp roles only
